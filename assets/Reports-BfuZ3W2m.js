import{t as e}from"./format-CX8swf-w.js";import{t}from"./circle-check-bfQLmigQ.js";import{t as n}from"./circle-adYnhipS.js";import{t as r}from"./loader-circle-BQtoEXg5.js";import{L as i,R as a,_ as o,d as s,et as c,g as l,j as u,l as d,m as f,o as p,rt as m,t as h,z as g}from"./index-C0T8JR40.js";import{i as _,n as v,r as y,t as b}from"./card-CR6-T0_T.js";import"./badge-DirAkysT.js";import{r as x}from"./workingDays-BAytrTqX.js";import{t as S}from"./progress-CMvTaKly.js";var C=l(`clipboard-list`,[[`rect`,{width:`8`,height:`4`,x:`8`,y:`2`,rx:`1`,ry:`1`,key:`tgr4d6`}],[`path`,{d:`M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2`,key:`116196`}],[`path`,{d:`M12 11h4`,key:`1jrz19`}],[`path`,{d:`M12 16h4`,key:`n85exb`}],[`path`,{d:`M8 11h.01`,key:`1dfujw`}],[`path`,{d:`M8 16h.01`,key:`18s6g9`}]]),w=l(`printer`,[[`path`,{d:`M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2`,key:`143wyd`}],[`path`,{d:`M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6`,key:`1itne7`}],[`rect`,{x:`6`,y:`14`,width:`12`,height:`8`,rx:`1`,key:`1ue0tg`}]]),T=m(c(),1),E=p(),D=[`cutting`,`embroidery`,`downFilling`,`template`,`finishing`,`packing`],O={cutting:`Cutting`,embroidery:`Embroidery / Print`,downFilling:`Down Filling`,template:`Template`,finishing:`Finishing`,packing:`Packing`},k={cutting:`#3b82f6`,embroidery:`#ec4899`,downFilling:`#06b6d4`,template:`#f59e0b`,finishing:`#a855f7`,packing:`#f97316`},A=Array.from({length:20},(e,t)=>`C-${String(t+1).padStart(2,`0`)}`),j=Array.from({length:20},(e,t)=>`A-${String(t+1).padStart(2,`0`)}`),M=(e,t)=>e.reduce((e,n)=>e+(Number(n[t])||0),0),N=e=>e.length>0?Math.max(...e.map(e=>Number(e.workersPresent)||0)):0,P=e=>e>=75?`#15803d`:e>=40?`#92400e`:`#991b1b`,F=e=>e>=90?`#15803d`:e>=75?`#1d4ed8`:e>=60?`#92400e`:`#991b1b`,I=e=>e>=90?`#dcfce7`:e>=75?`#dbeafe`:e>=60?`#fef3c7`:`#fee2e2`,L={active:{label:`Active`,bg:`#dbeafe`,color:`#1d4ed8`},completed:{label:`Completed`,bg:`#dcfce7`,color:`#15803d`},pending:{label:`Pending`,bg:`#fef3c7`,color:`#92400e`},delayed:{label:`Delayed`,bg:`#fee2e2`,color:`#991b1b`}},R=`
...
<div class="summary-grid summary-grid-4">
  ...
  <div class="summary-box" style="border-color:#ef4444">
    ...
    <table>
      ...
      <tbody>${t.map(t=>{let r=L[t.status]||L.pending,i=n[t.id]||0,a=t.qty>0?Math.min(100,Math.round(i/t.qty*100)):t.progress||0,o=i>0,s=t.completionDate&&t.shipDate?x(t.completionDate,t.shipDate):null,c=s!==null&&s<0?`<span style="color:#dc2626;font-size:7.5pt">⚠ ${Math.abs(s)}d overdue</span>`:s!==null&&s<=5?`<span style="color:#d97706;font-size:7.5pt">⚠ ${s}d gap</span>`:``;return`<tr>
    ...
    </table>`,!0)}function U(t){let n=t.filter(e=>e.status!==`completed`).sort((e,t)=>new Date(e.shipDate)-new Date(t.shipDate)),r=t.filter(e=>e.status===`completed`),i=e=>e.shipDate?Math.ceil((new Date(e.shipDate)-new Date)/864e5):null,a=t=>t.map(t=>{let n=L[t.status]||L.pending,r=i(t),a=t.completionDate&&t.shipDate?x(t.completionDate,t.shipDate):null,o=(t.milestones||[]).map(e=>{let t=e.done?`ms-done`:e.date&&new Date(e.date)<new Date?`ms-late`:`ms-pending`,n=e.done?`✓`:e.date&&new Date(e.date)<new Date?`✗`:`○`;return`<span class="${t}" title="${e.name}">${n} ${e.name.replace(`Material Arrival`,`Mat`).replace(`Embroidery Start`,`Emb`).replace(`Completion`,`Comp`).replace(`Ex-Factory`,`Ship`)}</span>`}).join(` &nbsp;·&nbsp; `);return`<tr>
