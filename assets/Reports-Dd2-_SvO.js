import{t as e}from"./format-tFH4SSM8.js";import{t}from"./circle-check-Dd6j-liM.js";import{t as n}from"./circle-JcQLwOGl.js";import{t as r}from"./loader-circle-B7WYD4Yl.js";import{t as i}from"./printer-Dph8VqwR.js";import{B as a,M as o,R as s,V as c,at as l,ct as u,f as d,g as f,o as p,t as m,u as h,v as g,y as _}from"./index-CTHzOo_E.js";import{i as v,n as y,r as b,t as x}from"./card-CZn_fUj4.js";import"./badge-CbXSFW1P.js";import{r as S}from"./workingDays-BAytrTqX.js";import{t as C}from"./progress-DpOBN7b9.js";var w=g(`clipboard-list`,[[`rect`,{width:`8`,height:`4`,x:`8`,y:`2`,rx:`1`,ry:`1`,key:`tgr4d6`}],[`path`,{d:`M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2`,key:`116196`}],[`path`,{d:`M12 11h4`,key:`1jrz19`}],[`path`,{d:`M12 16h4`,key:`n85exb`}],[`path`,{d:`M8 11h.01`,key:`1dfujw`}],[`path`,{d:`M8 16h.01`,key:`18s6g9`}]]),T=u(l(),1),E=p(),D=[`cutting`,`embroidery`,`downFilling`,`template`,`finishing`,`packing`],O={cutting:`Cutting`,embroidery:`Embroidery / Print`,downFilling:`Down Filling`,template:`Template`,finishing:`Finishing`,packing:`Packing`},k={cutting:`#3b82f6`,embroidery:`#ec4899`,downFilling:`#06b6d4`,template:`#f59e0b`,finishing:`#a855f7`,packing:`#f97316`},A=Array.from({length:20},(e,t)=>`C-${String(t+1).padStart(2,`0`)}`),j=Array.from({length:20},(e,t)=>`A-${String(t+1).padStart(2,`0`)}`),M=(e,t)=>e.reduce((e,n)=>e+(Number(n[t])||0),0),N=e=>e.length>0?Math.max(...e.map(e=>Number(e.workersPresent)||0)):0,P=e=>e>=75?`#15803d`:e>=40?`#92400e`:`#991b1b`,F=e=>e>=90?`#15803d`:e>=75?`#1d4ed8`:e>=60?`#92400e`:`#991b1b`,I=e=>e>=90?`#dcfce7`:e>=75?`#dbeafe`:e>=60?`#fef3c7`:`#fee2e2`,L={active:{label:`Active`,bg:`#dbeafe`,color:`#1d4ed8`},completed:{label:`Completed`,bg:`#dcfce7`,color:`#15803d`},pending:{label:`Pending`,bg:`#fef3c7`,color:`#92400e`},delayed:{label:`Delayed`,bg:`#fee2e2`,color:`#991b1b`}},R=`
